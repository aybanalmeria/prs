...
<head>
  ...
  <title>Patient Registarion</title>
  ...
  <link href="<?php echo base_url('assets/css/sb-admin-2.min.css'); ?>" rel="stylesheet">
	<meta name="csrf_name" content="<?php echo $this->security->get_csrf_token_name(); ?>">
	<meta name="csrf_hash" content="<?php echo $this->security->get_csrf_hash(); ?>">
